...
echo "  • webhook-sync.yml: Webhook-triggered sync for real-time updates"
echo ""
print_info "Next steps:"
echo "  1. Go to the Actions tab in your repository to see the workflows"
echo "  2. Run 'Sync Repositories' manually for the initial sync"
echo "  3. The workflows will automatically sync changes going forward"
echo ""
